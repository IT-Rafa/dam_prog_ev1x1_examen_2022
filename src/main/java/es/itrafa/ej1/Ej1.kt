 ...
 * Tienes una circunferencia de hilo. Mides su radio r,
 * y, por lo tanto, sabes que su diámetro es 2r. si esa circunferencia de hilo la cortas y
 * a continuación la mides, estás midiendo su perímetro, pues bien puedes observar que el
 * perímetro va a ser 3 veces el diámetro y un poquito más. Pruebas esto con muchas
 * circunferencias y siempre ocurre lo mismo, que el perímetro es “Tres veces el diámetro
 * y un poquito más”
 *
 *
 * Perímetro
